      ...
      {activeButtons.map((activeButton, index) => (
        <div key={index} className="flex gap-2 mb-6 text-sm">
          <label className="flex w-36 gap-2 items-center">
            ...
            {activeButton.icon === "Instagram" && <AiFillInstagram size={20} />}
            ...
            {activeButton.icon === "Telegram" && <FaTelegramPlane size={20} />}
            {activeButton.icon === "Twitter" && <FaSquareXTwitter size={20} />}
